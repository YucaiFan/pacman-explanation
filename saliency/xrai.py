...
_FELZENSZWALB_SCALE_VALUES = [15, 20, 35, 50, 100, 150, 250]

_FELZENSZWALB_SIGMA_VALUES = [0.6]
# _FELZENSZWALB_IM_RESIZE = (224, 224)
_FELZENSZWALB_IM_RESIZE = (160, 160)
_FELZENSZWALB_IM_VALUE_RANGE = [-1.0, 1.0]
_FELZENSZWALB_MIN_SEGMENT_SIZE = 50
...
class XRAI(SaliencyMask):
    ...
    # Check the shape of base_attribution.
        ...
        if base_attribution is None:
            ...
            print("x_baselines:", x_baselines[0].shape)
